...
public class ActionResult extends Action{
    ...
    private static final String path = "/omikuji-struts/csvomkj.csv";

    protected void doPost(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String viewpage = "/webapp/OmkjResult.jsp";
            javax.servlet.RequestDispatcher rd = request.getRequestDispatcher(viewpage);
